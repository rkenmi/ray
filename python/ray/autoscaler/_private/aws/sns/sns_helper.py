...
class SnsHelper:
    def __init__(self, region: str, **kwargs):
        """Constructor for SNS helper class. Re-uses the SNS client from the resource cache, if present.
        Args:
            region: The AWS Region used in instantiating the client.
            **kwargs: Additional keyword arguments specified when loading the SNS client from the resource cache.
        """
